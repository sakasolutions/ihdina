...
class ReflectionMomentFallbacks {
  ...
  static const List<String> daily = [
    ...
    'Ein ehrliches Bittgebet braucht keine langen Worte. Allah kennt die Absicht — oft früher als wir sie selbst verstehen. Was möchtest du heute leise anvertrauen?',
  ...
  static const List<String> friday = [
    ...
    'Jumuʿah verbindet: unterschiedliche Wege, ein gemeinsamer Ruf zur Nähe zu Allah. Du musst nicht alles allein tragen. Wo darfst du heute Unterstützung annehmen?',
    ...
    'Ein ruhiger Moment vor dem Gebet kann tiefer wirken als viele Worte danach. Was möchtest du Allah heute ohne Umschweife sagen?',
  ];
