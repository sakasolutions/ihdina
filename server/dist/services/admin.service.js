...
export async function searchUsersByInstallId(q, take = 20) {
    const term = q.trim();
    if (!term) {
...
export async function getUserDetailByInstallId(installId) {
...
export async function setUserProByInstallId(installId, isPro) {
