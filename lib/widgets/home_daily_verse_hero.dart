...
class HomeDailyVerseHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final takeawayLine =
        takeawayOneLine(personalTakeaway) ?? dailyTakeawayPlaceholder(surahNameEn, ayahNumber);
    final soft = takeawayNeutralPresentation;
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _accentGold.withOpacity(0.26),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
              ...
              child: Padding(
                ...
                child: ConstrainedBox(
                  ...
                  child: ClipRect(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    ...
                                    colors: [
                                      AppColors.emeraldDark.withOpacity(0),
                    ...
                    Center(
                      child: _MehrVerstehenGlassButton(onPressed: onMehrVerstehen),
                    ),
