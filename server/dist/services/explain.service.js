...
import { bumpDailyExplanationExtraCount, getDailyExplanationExtraCount, } from "./dailyExplanationUsageQueries.js";
import { completeExplanation } from "./openai.service.js";
import { getOrCreateUser } from "./user.service.js";
import { logAiRequest } from "./usageLog.service.js";
export async function explainVerse(input) {
    ...
    if (!user.isPro) {
        if (!input.isDailyVerse) {
            ...
            if (used >= MAX_FREE_EXTRA_EXPLANATIONS_PER_DAY) {
                ...
                throw new AppError(ErrorCodes.FREE_LIMIT_REACHED, "Your daily limit for extra explanations has been reached.", 403);
            }
        }
    }
    let completion;
